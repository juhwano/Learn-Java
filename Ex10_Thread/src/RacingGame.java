...
public class RacingGame extends Thread {
	...
	public static void main(String[] args) {
		RacingGame R1 = new RacingGame("1번馬");
		RacingGame R2 = new RacingGame("2번馬");
		RacingGame R3 = new RacingGame("3번馬");
		RacingGame R4 = new RacingGame("4번馬");
		RacingGame R5 = new RacingGame("5번馬");
		RacingGame R6 = new RacingGame("6번馬");
