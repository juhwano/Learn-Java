...
>>class 권총{}                  사물함에 있다.
>>class 경찰{}
    void 출동(권총){}           항상 권총을 지니고 있지 않다. 출동할 때 차고 나감(호출).
...
class Shape{
	String color="gold"; //원래는 생성자에서 초기화하는 게 맞다. 하지만 연습 default에서 초기화
	void draw() {
...
class Point{
	...
	int y;
	Point(){
//		this.x = 1; //초기값 1.1 점을 설정하지 않아도 기본값이 잡히고
//		this.y = 1;
